...
public class ProtocolTest {
    ...
    @Test
    public void test() {
        String filedName[] = new String[]{"firstStartChar", "firstLength", 
                "secondLength", "secondStartChar","control", 
                "address", "afn", "seq", "dataId", "cs", "endChar"};
        int length[] = new int[]{1, 2, 2, 1, 1, 5, 1, 1, 4, 1, 1};
        String pkg = "6823002300688803130100008C6900000107F716";
    ...
    public void testWithListImformation() {
        String fieldName[] = new String[]{"firstStartChar", "firstLength", 
                "secondLength", "secondStartChar","control", 
